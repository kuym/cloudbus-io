...
{
	if(cloudbusSettings && cloudbusSettings.namingRules[word])	return(cloudbusSettings.namingRules[word]);
...
jQuery(function($)
{
	...
	!(function()
	{
		var path = cloudbusSettings.locationOverride || (window && window.location && window.location.pathname) || "";
